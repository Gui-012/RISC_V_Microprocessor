...
#
# RISC_V_Microprocessor.tcl: Tcl script for re-creating project 'RISC_V_Microprocessor'
#
...
set _xil_proj_name_ "RISC_V_Microprocessor"
...
set script_file "RISC_V_Microprocessor.tcl"
...
set_property -name "webtalk.xsim_launch_sim" -value "265" -objects $obj
...
set_property -name "top" -value "Microprocessor" -objects $obj
...
set file "$origin_dir/srcs/testbench/Memory_Interface_tb.sv"
set file [file normalize $file]
...
set file "new/Microprocessor_tb.sv"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set_property -name "top" -value "Microprocessor_tb" -objects $obj
...
set file "synth_1/Memory_Interface.dcp"
...
set_property -name "incremental_checkpoint" -value "$proj_dir/RISC_V_Microprocessor.srcs/utils_1/imports/synth_1/Memory_Interface.dcp" -objects $obj
